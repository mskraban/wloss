...
<body id="w-background" class="bg-opravila">
...
<script>
    $(document).ready(function() {
        ...
        else if (previous == "http://localhost/chores/koledar.php") {
            var classBg = "bg-calendar-nf";
            $('body').addClass(classBg);
        }
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="container-menu" id="auto-dash">
            ...
            <div class="row">
                <div class="col-12 col-lg-12 col-xl-12 widget">
                    <div class="widget-auto bg-purp text-white">
                        <div class="row">
                            <div class="col-12 task-first">Seznam opravil</div>
                            <div class="col-12 divider"></div>
                            <div class="col-12 task">
                                <div class="col-2"><i class="far fa-square"></i></div>
                                <div class="col-2">Kuhanje</div>
                                <div class="col-3">
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-3">Visoka prioriteta</div>
                                <div class="col-2">Aktivno</div>
                            </div>
                            <div class="col-12 divider"></div>
                            <div class="col-12 task">
                                <div class="col-2"><i class="far fa-square"></i></div>
